...
class Node:
    ...
    def getChildren(self,node):
        ...
        for child in self.children:
            if child.name == name and child.isDir == node.isDir:
                return child
        return node
...
class fileTree:
    ...
    def loadNode(self,node):
        ...
        for it in items:
            ...
            child = node.getChildren(newNode)
    ...
    def setCurrentFile(self,filePath):
        ...
        if parentDir != root_path and parentDir.endswith("\\"):
    ...
    def constructUltimateRoot(self):
        if self.ultimate_root != None:
            return
        self.ultimate_root = Node(root_path,None)
